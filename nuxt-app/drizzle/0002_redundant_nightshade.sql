...
--> statement-breakpoint
INSERT INTO `__new_user`("id", "name", "email", "email_verified", "image", "created_at", "updated_at", "birth_day") SELECT "id", "name", "email", "email_verified", "image", "created_at", "updated_at", "birth_day" FROM `user`;--> statement-breakpoint
